...
class Terminal(banner: String) extends Display.Hardware {
  ...
  /** location of mark */
  private var mark_col = -1
  private var mark_line = -1
  ...
  private var dribble: PrintWriter = _
  ...
  private class Screen extends JPanel {
    ...
    setPreferredSize(
      new Dimension(Display.WIDTH * char_width + 2 * border,
    ...
    private def keyPressed(ev: KeyEvent) {
      ...
      ev.getKeyCode match {
        case KeyEvent.VK_CONTROL | KeyEvent.VK_SHIFT | KeyEvent.VK_ALT => return
